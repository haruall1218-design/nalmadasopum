...
오늘은 미싱 왕초보도 쉽게 완성할 수 있는 **'바란스 커튼'**을 만들어보려고 합니다. 
...
> ★ 압축봉의 굵기에 따라 사이즈를 짥게 또는 넓게 조절하시면 됩니다. <br>
> ★ 원하시는 공간에 딱 맞게 하실 때에는 원단을 먼저 세탁하신 후 제작 하시거나 가로, 세로 0.5~1cm정도 더 크게 제작하시면 세탁후 줄어듬을 방지할 수 있습니다.

> 💡 **날마다 소품의 꿀팁! (가로로 자연스럽게 주름이 잡히게 제작 하려면 ~ )**<br><br>
> ★ 가로 사이즈 : 가로 길이의 1.5배<br>
> ★ 세로 사이즈 : 세로 길이 + 위쪽 압축봉 들어갈 사이즈와 시접 8~10cm + 밑단 시접 2cm<br>
> ★ 커튼의 자연스러운 주름을 원하시면 창문 가로 길이가 60cm라면, 원단은 90cm~100cm 정도로 넉넉하게 재단해야 걸었을 때 예쁜 주름이 생깁니다.
...
![라벨을 다는 모습]({{ site.kor_url }}/assets/images/making-note/260923-valance-tutorial-09.jpg)
...
바란스 커튼은 원단의 무늬나 질감에 따라 분위기가 많이 달라집니다. 계절이 바뀔 때마다 봄에는 화사한 잔꽃 무늬로, 겨울에는 따뜻한 체크무늬로 커튼만 하나 바꿔 달아도 기분 전환이 확실히 됩니다. 밑단에 예쁜 토션 레이스를 달아주면 로맨틱한 빈티지 커튼으로도 응용할 수 있답니다.
